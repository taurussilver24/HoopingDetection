...
class ShotDetector:
    def __init__(self, model_path, video_path,video_name):
        # Load YOLO model created from main.py - change to relative path
        self.model = YOLO(model_path)
        self.class_names = ['Ball', 'Hoop']

        # Use video - replace text with video path
            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    if conf > 0.75:
                        ...
                        if (current_class == "Ball" and conf > 0.7) or \
        ...
        if len(self.hoop_pos) > 0 and len(self.ball_pos) > 0:
            ...
            if self.frame_count % 10 == 0:
                if self.up and self.down and self.up_frame < self.down_frame:
                    ...
                    # Record result and video timing (in seconds)
