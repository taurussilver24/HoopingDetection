...
class ShotDetector:
    def __init__(self, model_path, video_path,video_name):
        ...
        self.csv_file = open('Results/' + video_name + '/ground_truth.csv', mode='w', newline='')
                ...
                for r in results:
                    ...
                    for box in boxes:
                        ...
                        if conf > 0.75:
                            ...
                            if (current_class == "Ball" and conf > 0.5) or (
    ...
    def add_csv_entry(self):
        ...
        print(
            f"CSV Entry Added: {self.attempts}, Shot Detected, {ball_center}, {hoop_center}, {current_score}, {video_timing_seconds:.2f}")
